...
이 함수는 `content`에서 각 헤딩딩 태그를 추출해 `id`, `text`, `level`을 반환한다.
...
**더욱 자세한 훅의 내용은 [여기](https://github.com/bbjbc/boongranii.dev/blob/main/src/hooks/useHeadingObserver.ts)에서 확인할 수 있다.**
